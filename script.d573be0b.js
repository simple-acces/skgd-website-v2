...
var countups = function countups(goUp) {
  return [["n1", 6], ["n2", 10], ["n3", 5], ["n4", 50]].map(function (_ref) {
...
var observer = new IntersectionObserver(function (_ref3) {
  ...
  return countups(isIntersecting).forEach(function (c) {
    return c.start();
  });
}, {
  threshold: 1
...
var initNumbers = function initNumbers() {
